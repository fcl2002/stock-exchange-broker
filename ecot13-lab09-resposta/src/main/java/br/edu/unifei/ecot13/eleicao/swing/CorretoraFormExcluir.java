...
public class CorretoraFormExcluir extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CorretoraFormExcluir frame = new CorretoraFormExcluir();
	...
	public CorretoraFormExcluir() {
		...
		btnExcluir.setBounds(42, 332, 89, 23);
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if((operacao != null) && (bolsa != null) && (acao != null) ) {
					...
					textCodigo.setText(operacao.getCodigo());
					textCodigo.setEnabled(false);
					textNome.setText(bolsa.getNome());
					textNome.setEnabled(false);
					textTicket.setText(acao.getTicket());
